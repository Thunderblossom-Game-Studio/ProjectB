...
namespace RVP
{
    ...
    public class PredictedVehicle : NetworkBehaviour
    {
        ...
        [Replicate]
        private void Move(BasicInput.MoveData md, bool asServer, Channel channel = Channel.Unreliable, bool replaying = false)
        {
        ...
        [Reconcile]
        private void Reconciliation(ReconcilationData rd, bool asServer, Channel channel = Channel.Unreliable)
        {
        ...
        private void TimeManager_OnPreReplicateReplay(uint arg1, PhysicsScene arg2, PhysicsScene2D arg3)
        {
#if SYNC_DEBUG
            // sync debug - not compiled unless SYNC_DEBUG is set as global define
            StaticStateLogger.Log("************************************");
        ...
        public struct ReconcilationData : IReconcileData
        {
            public byte[] Data;
